		...
		require("conexionMiSitioWebPrueba.php");
   		...
   		while($registros = $resultado->fetch(PDO::FETCH_ASSOC)){
   			...
   			$ruta_img = $registros["nombre_imagen"];
				...
				echo "<a href='/Dudwlandia/Imagenes/$ruta_img' rel='gallery' title='$ruta_img'><img src='/Dudwlandia/Imagenes/$ruta_img' alt='Imagen no escontrada' width='90px' height='90px'></a>";
